							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="<?php echo e(asset('public/frontEnd/images/')); ?>/woo1.jpg" alt=" "/></a>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="<?php echo e(url('/category')); ?>">Clothing</a></li>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="<?php echo e(asset('public/frontEnd/images/')); ?>/woo.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
